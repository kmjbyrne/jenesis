(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Coradel", [], factory);
	else if(typeof exports === 'object')
		exports["Coradel"] = factory();
	else
		root["Coradel"] = factory();
...
var init = function () {
    ...
    var parallax = new _parallax.Parallax();
}();
...
var Component = exports.Component = function () {
    function Component(element) {
        ...
        var shift = function shift(nextOrPrev) {
            var slideLength = _this.slides.length - 1;
            if (nextOrPrev) {
                if (_this.index === slideLength) {
                    _this.index = 0;
                } else {
                    _this.index++;
                }
                ...
                if (_this.index === 0) {
                    _this.index = slideLength;
                } else {
                    _this.index--;
                }
            }
            _this._slideTo(_this.index);
        };
    ...
    _createClass(Component, [{
        key: "_slideTo",
        value: function _slideTo(slideIndex) {
        ...
        value: function stopStart() {
            var self = this;
            self.element.addEventListener("mouseover", function () {
                clearInterval(self.timer);
                self.timer = null;
            }, false);
            self.element.addEventListener("mouseout", function () {
                self.action();
            }, false);
        }
    }]);
...
var Slideshow = exports.Slideshow = function () {

    var COMPONENT_NAME = 'slideshow';
    var VERSION = '0.0.1';
    var SELECTOR = "[data-coradel='slide']";
    ...
    var Slideshow = function () {
        function Slideshow(element) {
            var iife = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
var Parallax = exports.Parallax = function () {
    var COMPONENT_NAME = 'slideshow';
    var VERSION = '0.0.1';
    var SELECTOR = "[data-coradel='parallax']";
                ...
                window.onscroll = function () {
                    window.requestAnimationFrame(function () {
                        for (var i = 0; i < _this.count; i++) {
                            var currentElement = _this.elements[i];
                            var scrolled = window.scrollY - 1950;
...
//# sourceMappingURL=coradel.min.js.map